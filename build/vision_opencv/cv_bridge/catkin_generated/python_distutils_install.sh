...
cd "/users/studs/bsc/2015/barakgo/catkin_ws/src/vision_opencv/cv_bridge"
...
/usr/bin/env \
    ...
    build --build-base "/users/studs/bsc/2015/barakgo/catkin_ws/build/vision_opencv/cv_bridge" \
    install \
    $DESTDIR_ARG \
